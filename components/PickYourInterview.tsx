  ...
  <div className="group relative h-full">
    <Link href={`/interviews/${interview.id}`} className="block no-underline h-full">
      ...
      <div className="bg-[#1A2138]/60 backdrop-blur-sm border border-[#4D4DFF]/20 rounded-xl overflow-hidden transition-all duration-300 h-full flex flex-col
        ...
        {/* Ultra-compact card body with date and score side by side - optimized containers */}
        <div className="p-4 xl:p-5 pt-4 xl:pt-5 pb-2 xl:pb-3 px-3 xl:px-4">
          <div className="flex items-center justify-center gap-3">
            {/* Compact date display */}
            <div className="flex items-center bg-[#0E1428]/50 backdrop-blur-sm rounded-lg py-1 px-2 border border-[#4D4DFF]/10 w-auto">
              <div className="w-4 h-4 rounded-full bg-gradient-to-br from-[#4D4DFF]/10 to-[#01CDFE]/10 flex items-center justify-center mr-1.5 border border-[#4D4DFF]/20">
                <Clock className="w-2 h-2 text-[#01CDFE]" />
              </div>
              <span className="text-[#E2F0FF] font-medium text-xs whitespace-nowrap">{formatDate(interview.date)}</span>
            </div>
            ...
            <div className="flex items-center bg-[#0E1428]/50 backdrop-blur-sm rounded-lg py-1 px-2 border border-[#4D4DFF]/10 w-auto">
              <div className="relative mr-1.5">
                ...
                <div className="w-4 h-4 rounded-full bg-[#0E1428] border border-[#4D4DFF]/20 flex items-center justify-center">
                  {/* Circular progress indicator */}
                  <svg className="absolute inset-0" width="100%" height="100%" viewBox="0 0 16 16">
                    <circle
                      cx="8"
                      cy="8"
                      r="6.5"
                      ...
                      stroke="#FFC700"
                      strokeWidth="1.2"
                      strokeDasharray={`${(interview.score / 100) * 40.84} 40.84`}
                  ...
                  <Star className="w-2 h-2 text-[#FFC700] z-10" />
                </div>
              </div>
              <span className="text-[#E2F0FF] font-medium text-xs whitespace-nowrap">
